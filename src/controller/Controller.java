...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        imgPatterns = new ImagePattern[] {new ImagePattern(new Image("images/buttonMastermindYellow.png")), new
                ImagePattern(new Image("images/buttonMastermindOrange.png")), new ImagePattern(new Image("images/buttonMastermindGreen.png")),
        new ImagePattern(new Image("images/buttonMastermindBlue.png")), new ImagePattern(new Image("images/buttonMastermindViolet.png")),
        new ImagePattern(new Image("images/buttonMastermindRed.png")), new ImagePattern(new Image("images/buttonMastermindBlack.png")),
        new ImagePattern(new Image("images/buttonMastermindSilver.png"))};
        ...
        seq = new Sequence();
        for (String s : seq.getSeqOfColors()) {
            System.out.println(s);
        }
    }

    private void loopThroughCircleImages(Node n, int i, Button btn) {
    ...
    private void checkSequence(AnchorPane apTry, AnchorPane ck, Button btn1, Button btn2) {
        ...
        if (!allChosenCircles) {
            ...
            if (rightColorAndPosition == 4) {
                ...
                for (int i = 0; i < seqToTry.length; i++) {
                    ((Circle)apTry10.getChildren().get(i)).setFill(new ImagePattern(new Image("images/buttonMastermind" + seqToTry[i] + ".png")));
                }
            ...
            if (apTry == apTry9 && rightColorAndPosition != 4) {
                ...
                for (int i = 0; i < seq.getSeqOfColors().length; i++) {
                    ((Circle)apTry10.getChildren().get(i)).setFill(new ImagePattern(new Image("images/buttonMastermind" + seq.getSeqOfColors()[i] + ".png")));
                }
